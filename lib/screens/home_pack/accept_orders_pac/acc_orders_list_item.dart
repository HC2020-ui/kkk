...
class AccOrdersListItem extends StatefulWidget {
  @override
  _AccOrdersListItemState createState() => _AccOrdersListItemState();
}

class _AccOrdersListItemState extends State<AccOrdersListItem> {
  @override
  Widget build(BuildContext context) {
    return InkWell(
      onTap: () {
        Navigator.push(
          context,
          MaterialPageRoute(builder: (context) => AcceptOrderDetails()),
        );
      },
      child: Container(
