                      ...
                      child: Container(
                        ...
                        child: ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            return new ListTile(
                              title: Expanded(child: Text('Add Employee', style: TextStyle(
                    ...
                    return Scaffold(
                      appBar: AppBar(
                        ...
                        title: Container(
                          ...
                          child: Row(
                            children: <Widget>[
                              Expanded(child: Text("LOGO", style: TextStyle(color: AppColors.white, fontSize: 16, fontWeight: FontWeight.bold),)),
                              Spacer(flex: 2,),
                              Align(
                                  alignment: Alignment.center,
                                  child: Text("Add Employee", style: TextStyle(color: AppColors.white, fontSize: 16, fontWeight: FontWeight.bold),)),
